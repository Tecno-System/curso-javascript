...
const listaDeherois = document.querySelector('.listaDeHerois');

function createHeroInfo(herois) {
  return herois.map(function(heroi){
    return `
      <div class="heroi">
        <img src="${heroi.imagem}" alt="Super Homem">
          <h2>${heroi.nome}</h2>
          <ul>
...
listaDeherois.innerHTML = createHeroInfo(herois);